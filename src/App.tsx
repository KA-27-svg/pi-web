...
export default function App() {
  const { messages, status, sendPrompt, abort, changeCwd, newSession, setModel, setThinkingLevel, setShellTool, requestSessions, requestStats, uploadFile, listDir, readAttachment, pickFile, switchSession, renameSession, deleteSession, requestTrash, restoreSession, purgeSession, emptyTrash } =
    usePiWebSocket();
      ...
      <div className="relative flex min-w-0 flex-1 flex-col">
        ...
        {panelOpen && (
          <SettingsPanel
            ...
            onSelectShellTool={setShellTool}
          />
        )}
