...
export default function App() {
  const { messages, status, sendPrompt, abort, changeCwd, newSession, setModel, setThinkingLevel, setReadOnly, requestSessions, requestStats, uploadFile, listDir, readAttachment, pickFile, openAttachment, switchSession, renameSession, deleteSession, requestTrash, restoreSession, purgeSession, emptyTrash } =
    usePiWebSocket();
      ...
      <div className="relative flex min-w-0 flex-1 flex-col">
        ...
        {panelOpen && (
          <SettingsPanel
            ...
            onToggleReadOnly={value => void setReadOnly(value).catch(() => undefined)}
          />
        )}
